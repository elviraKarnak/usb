...
function ___add_form_field_term_meta_text() { ?>
    ...
    <div class="form-field term-meta-text-wrap">
        <label for="term-meta-text"><?php _e( 'Video Link', 'text_domain' ); ?></label>
...
function ___edit_form_field_term_meta_text( $term ) {
    ...
    <tr class="form-field term-meta-text-wrap">
        <th scope="row"><label for="term-meta-text"><?php _e( 'Video Link', 'text_domain' ); ?></label></th>
        <td>
            <?php wp_nonce_field( basename( __FILE__ ), 'term_meta_text_nonce' ); ?>
...
function ___edit_term_columns( $columns ) {
    ...
    $columns['__term_meta_text'] = __( 'Video Link', 'text_domain' );
