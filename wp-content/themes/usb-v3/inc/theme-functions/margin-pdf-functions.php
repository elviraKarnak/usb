...
if (!function_exists('usb_v3_margin_pdf_extract_cells')) {
    function usb_v3_margin_pdf_extract_cells($html)
    {
        $cells = array();
...
if ($offer_post_id) {
    ...
    $summary_cells = usb_v3_margin_pdf_extract_cells($summary_source);
    ...
    $aDataTableDetailHTML = usb_v3_margin_pdf_extract_cells($custom_product_data_source);
