...
//     global $product;
//     if(isset($_REQUEST['color_att'])):
//       $custom_sku_meta= 'custom_sku_'.$_REQUEST['color_att'];
//       $custom_sku_meta_value=get_post_meta($product->get_id(), $custom_sku_meta, true);
//       if($custom_sku_meta_value):
//           echo '<div class="cus-sku" >' . $custom_sku_meta_value.'</div>';
//       else:
