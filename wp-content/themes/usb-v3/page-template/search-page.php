    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8 mt-lg-0 mt-4">
               ...
               <h4 class="mb-4 heading-product">Serch Result For: <?php echo $searchPage; ?></h4>

                <input type="hidden" name="s_query" id="s_query" value="<?php echo $searchPage; ?>">
