    ...
    <div class="container">
        ...
        <div class="row">
            ...
            //if($parent){
                ...
                $menuName = get_field('menu_cats_list');
			...
			<?php 
				//$queried_object = get_queried_object();
					$term_ids = get_field('product_category_list');
					$args = array(
						...
						'tax_query' => array(
							array(
								...
								'terms' => $term_ids,
                                 'operator' => 'IN', // Replace with the actual term ID
							),
						),
					);
			...
			?>
               ...
               <h2 class="mb-4 heading-product"><?php the_title(); ?></h2>
