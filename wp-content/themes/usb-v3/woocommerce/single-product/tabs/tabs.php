      ...
      <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
        ...
        <div class="accordion-body">
          <?php if ($product_data_chk == 'yes') { ?>
              ...
              //var_dump( $field_chunks);

              
              if(!empty($field_chunks)){
            
             echo '<div id="productdata" class="product-data main_specification_table">';
              ...
              foreach ($field_chunks as $column) {
                echo '<td style="vertical-align: top;">';
                  if($i == 1 ) {
                    echo '<h3>' . __('Produkt Information', 'usb') . '</h3>';
                  } else {
                    echo '<h3>' . __('Produkt Specifikationer', 'usb') . '</h3>';
                  }
                echo '<table style="width: 100%;">';
                foreach ($column as $field_name => $label) {
...
<?php } ?>*/ ?>
  ...
  <?php $productdata_content = get_post_meta(get_the_ID(), 'productdata_content', true);
  
    if(!empty($productdata_content)){
  ?>

<!-- <div class="accordion-item">
  <h2 class="accordion-header" id="flush-heading_pd_h">
    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
          data-bs-target="#flush-heading_pd_c" aria-expanded="false" aria-controls="flush-heading_pd_c">

            <?php echo _e('Produktdata', 'usb'); ?></li>
        </button>
      </h2>


       <div id="flush-heading_pd_c" class="accordion-collapse collapse" aria-labelledby="flush-heading_pd"
        data-bs-parent="#producttabcontent">
        <div class="accordion-body">
