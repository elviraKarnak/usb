<?php
  ...
  <form action="<?php echo get_site_url(); ?>/cart" class="form-horizontal" method="post" >
     <div class="col-xs-12 col-sm-12 standard-product">
                     ...
                     <table class="table" data-dd="<?php echo $roles[0];?>">
                        ...
                        <tbody>
                           <?php
                              ...
                              $price_option_50 = get_post_meta(get_the_ID(), '_price_option_50', true);
                              if ( $rate_change > 0 ) {
                           ...
                           <?php
                              ...
                              ?>
                           <?php
                              $price_option_100 = get_post_meta(get_the_ID(), '_price_option_100', true);
                              if ( $rate_change > 0 ) {
                                  $price_option_100 = $rate_change * $price_option_100;
                              }
                           ...
                           <?php
                              ...
                              ?>
                           <?php
                              $price_option_250 = get_post_meta(get_the_ID(), '_price_option_250', true);
                              if ( $rate_change > 0 ) {
                                  $price_option_250 = $rate_change * $price_option_250;
                              }
                           ...
                           <?php
                              ...
                              ?>
                           <?php
                              $price_option_500 = get_post_meta(get_the_ID(), '_price_option_500', true);
                              if ( $rate_change > 0 ) {
                           ...
                           <?php
                              ...
                              // if ( !in_array( 'customer', (array) $user->roles ) ) {
                                ...
                                $price_option_1000 = get_post_meta(get_the_ID(), '_price_option_1000', true);
                                if ( $rate_change > 0 ) {
                                    $price_option_1000 = $rate_change * $price_option_1000;
                                }
                           ...
                           <?php
                              ...
                              ?>
                           <?php
                              $price_option_2500 = get_post_meta(get_the_ID(), '_price_option_2500', true);
                              if ( $rate_change > 0 ) {
                                  $price_option_2500 = $rate_change * $price_option_2500;
                              }
                           ...
                           <?php
                              ...
                              ?>
                           <?php
                              $price_option_5000 = get_post_meta(get_the_ID(), '_price_option_5000', true);
                              if ( $rate_change > 0 ) {
                                  $price_option_5000 = $rate_change * $price_option_5000;
                              }
                    ...
                    <?php
                       if ($terms && !is_wp_error($terms)) {
                           foreach ($terms as $term) {
                               ...
                               if ( $rate_change > 0 ) {
                                   $price50   = $rate_change * $price50;
                                   $price100  = $rate_change * $price100;
                                   $price250  = $rate_change * $price250;
                                   $price500  = $rate_change * $price500;
                                   $price1000 = $rate_change * $price1000;
                                   $price2500 = $rate_change * $price2500;
                                   $price5000 = $rate_change * $price5000;
                               }
        ...
        <div class="col-xs-12 col-sm-7 summary">
           ...
           <div class="cus-margin">
              ...
              <div class="cus-margin-btn-warp">
                 ...
                 <?php //_e( 'Export', 'usb' );?></a> -->
                 <a class="down_pdf_summary marginpdf" href="?marginpdf=<?php echo get_the_ID();?>&lang=<?php echo $_GET['lang']?$_GET['lang']:'en';?>" target="_blank" data-productId="<?php echo $id;?>"><?php _e( 'Product Margain quote', 'usb' );?></a>

                 <a class="down_pdf_summary" href="?offerpdf=<?php echo get_the_ID();?>&lang=<?php echo $_GET['lang']?$_GET['lang']:'en';?>" target="_blank" data-productId="<?php echo $id;?>"><?php _e( 'Product Price Quote', 'usb' );?></a>
              </div>
           </div>
        </div>
     </div>
