...
<h2><?php _e('CONFIGURING', 'usb' );?></h2>
<h4><?php _e('Choose Options', 'usb' );?></h4>
				...
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					<tr>
						<td class="value">
							...
							?>
							<label class="attribute_name_products" for="<?php echo sanitize_title( $attribute_name ); ?>"><?php echo wc_attribute_label( $attribute_name ); ?></label>
						</td>
